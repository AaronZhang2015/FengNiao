...
let fileExtensionsOption = MultiStringOption(shortFlag: "f", longFlag: "file-extension", helpMessage: "File Extensons to search with.")
let help = BoolOption(shortFlag: "h", longFlag: "help", helpMessage: "Prints a help message.")

cli.addOptions(projectOption, resourceExtensionsOption, fileExtensionsOption, help, excludePathsOption)
...
let resourceExtensions = resourceExtensionsOption.value ?? ["jpg", "png", "imageset"]
